...
export default function BestSelling() {
  const foodItems: FoodItem[] = [
    ...
    { id: 2, name: "Cheese Burger", price: "$18.00", category: "Lunch", image: "https://images.unsplash.com/photo-1540981493580-8ea1113e9968?q=80&w=1935&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" },
  ...
  return (
    <section className="container w-10/12 mx-auto my-8">
      <h2 className="text-3xl font-bold text-center text-emerald-600 dark:text-white">Best Selling</h2>
      ...
      <Link
        to="/menu"
        className="block w-full text-end text-emerald-600 dark:text-white hover:text-emerald-300 my-3"
      >
        View Menu →
      </Link>
    </section>
